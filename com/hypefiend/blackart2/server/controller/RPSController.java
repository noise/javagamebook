...
import com.hypefiend.blackart2.games.rps.*;
import com.hypefiend.blackart2.server.*;
import com.hypefiend.blackart2.server.controller.*;
...
public class RPSController extends GameController {
	...
	//    todo: check for player in players hash, else only allow login events
	...
	// todo: allow a p2_id of "computer" to play against random computer opponent
	...
	//todo: has this player already entered a move?
	...
	// todo: either finsih vs. computer play or remove
// 	// generate our move
// 	int n = (int)(Math.random() * 3.0f);
// 	log.debug("chose move: " + n + " = " + moves[n]);
